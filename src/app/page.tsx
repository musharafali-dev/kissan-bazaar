...
export default function HomePage() {
  ...
  // Mandi rates mock
  const mandiRates = [
    { crop: "Potato (آلو)", city: "Gilgit", price: "Rs. 80/kg", change: "+5%" },
    { crop: "Tomato (ٹماٹر)", city: "Lahore", price: "Rs. 120/kg", change: "-2%" },
    { crop: "Apricot (خوبانی)", city: "Hunza", price: "Rs. 180/kg", change: "0%" },
    { crop: "Onion (پیاز)", city: "Multan", price: "Rs. 95/kg", change: "+12%" }
  ];
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden font-sans">
      ...
      <div className="absolute top-[20%] left-[-10%] w-[40%] h-[40%] rounded-full bg-primary/5 filter blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[45%] h-[45%] rounded-full bg-secondary/5 filter blur-[120px] pointer-events-none" />
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 pt-6 md:pt-16 pb-12 md:pb-24 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[calc(100vh-80px)]">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center order-2 lg:order-1 mt-4 lg:mt-0">
          <div className="glass-panel p-8 md:p-12 relative overflow-hidden transition-all duration-300 shadow-glass border-white/60">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[56px] leading-[1.1] font-heading font-extrabold text-primary-dark tracking-tight mb-6">
              Sell Fresh.<br />
              <span className="text-secondary-dark font-black">Buy Direct.</span>
            </h1>
            ...
            <div className="pt-6 border-t border-primary/10 grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center sm:flex-row gap-2 text-center sm:text-left">
                ...
                <span className="text-xs md:text-sm font-semibold text-foreground/80">Verified Farmers</span>
              </div>
              <div className="flex flex-col items-center sm:flex-row gap-2 text-center sm:text-left">
                <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                  <Leaf size={18} />
                </div>
                <span className="text-xs md:text-sm font-semibold text-foreground/80">Same-Day Harvest</span>
              </div>
              <div className="flex flex-col items-center sm:flex-row gap-2 text-center sm:text-left">
                <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                  <Coins size={18} />
                </div>
                <span className="text-xs md:text-sm font-semibold text-foreground/80">COD + JazzCash</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 relative order-1 lg:order-2 w-full aspect-[4/3] lg:aspect-square flex items-center justify-center min-h-[300px]">
          ...
          <div className="w-[85%] h-[85%] rounded-[32px] overflow-hidden shadow-2xl relative border-4 border-white/80 group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary-dark/40 to-transparent z-10 transition-opacity group-hover:opacity-20 duration-300" />
            <Image 
          ...
          {/* FLOATING MORPH CARD 1: Potato Price */}
          <div className="absolute top-[8%] left-[2%] w-48 md:w-56 glass-panel p-4 shadow-glass border-white/60 animate-float">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-foreground">Potato / آلو</h4>
                <p className="text-base font-extrabold text-primary-dark">Rs. 80 / kg</p>
              </div>
            </div>
          </div>

          {/* FLOATING MORPH CARD 2: Farmers Near You */}
          <div className="absolute bottom-[6%] right-[2%] w-56 md:w-64 glass-panel p-4 shadow-glass border-white/60 animate-float-delayed">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-xs md:text-sm font-bold text-foreground">12 Farmers Near You</h4>
          ...
          {/* FLOATING MORPH CARD 3: Seasonal badge */}
      ...
      {/* ========================================================
          SECTION 2: CONTENT HUB (Daily Mandi Rates, Weather, Tips)
          ======================================================== */}
      <section className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass-panel p-6 shadow-glass-soft flex items-center justify-between border-white/50">
            <div>
              <span className="text-xs font-bold text-accent uppercase tracking-wider">Region Weather</span>
              <h3 className="text-lg font-bold text-primary-dark mt-1">Gilgit-Baltistan</h3>
              <p className="text-2xl font-black text-foreground mt-2">24°C / Sunny</p>
              <p className="text-xs text-foreground/60 mt-1">Perfect conditions for harvest</p>
            </div>
          ...
          <div className="glass-panel p-6 shadow-glass-soft border-white/50 col-span-1">
            <div className="flex justify-between items-center mb-3">
              <span className="text-xs font-bold text-accent uppercase tracking-wider">Daily Mandi Rates</span>
            ...
            <div className="space-y-2">
              {mandiRates.map((rate, index) => (
                <div key={index} className="flex justify-between items-center text-xs md:text-sm py-1 border-b border-sage/20 last:border-0">
                  <span className="font-semibold text-foreground/80">{rate.crop}</span>
          ...
          <div className="glass-panel p-6 shadow-glass-soft flex flex-col justify-between border-white/50">
            <div>
              <div className="flex items-center gap-1.5 text-accent">
                <Lightbulb size={16} />
                <span className="text-xs font-bold uppercase tracking-wider">Daily Agri Tip</span>
              </div>
              <h3 className="text-sm md:text-base font-bold text-primary-dark mt-2 leading-snug">
                Optimizing Apricot Storage
              </h3>
            ...
            <Link href="#" className="text-xs font-bold text-primary hover:text-primary-dark flex items-center gap-1 mt-4">
      ...
      {/* ========================================================
          SECTION 3: BUYER MARKETPLACE (Crop Filters + Near You)
          ======================================================== */}
      <section id="marketplace" className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20">
        
        {/* Section Heading */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div>
            <span className="text-sm font-bold text-accent uppercase tracking-wider">In Season Near You</span>
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary-dark mt-1">
              Fresh Produce Marketplace
            </h2>
          </div>
          <div className="flex flex-wrap gap-2">
            {["all", "fruits", "vegetables", "grains", "dairy"].map((cat) => (
              <button
                key={cat}
        ...
        <div className="glass-panel p-6 mb-8 shadow-glass-soft border-white/50 grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <input 
              type="text" 
              placeholder="Search crops, regions or farmers..." 
              value={searchQuery}
          ...
          <div className="lg:col-span-4 flex items-center gap-4">
            <span className="text-xs font-bold text-foreground/75 shrink-0">Radius: <span className="text-primary font-bold">{radius} km</span></span>
            <input 
              type="range" 
              min="5" 
              max="150" 
          ...
          <div className="lg:col-span-3 flex justify-end">
            <label className="flex items-center gap-3 cursor-pointer">
              <span className="text-xs font-bold text-foreground/75">Organic Certified Only</span>
          ...
          {featuredCrops.map((crop) => (
            <div key={crop.id} className="glass-panel overflow-hidden flex flex-col justify-between group shadow-glass-soft border-white/60 hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
              ...
              <div className="aspect-[4/3] relative w-full overflow-hidden bg-sage-light">
                ...
                />
                <span className="absolute top-3 left-3 bg-white/90 backdrop-blur-xs text-xs font-bold text-primary px-2.5 py-1 rounded-full shadow-sm flex items-center gap-1 border border-primary/10">
                  Grade {crop.grade}
                </span>
              ...
              <div className="p-5 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-3 bg-primary/5 py-1.5 px-3 rounded-xl border border-primary/5">
                    ...
                    <span className="text-xs font-semibold text-primary-dark flex items-center gap-1">
                      {crop.farmer}
                      <CheckCircle size={10} className="fill-primary text-white" />
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-sage/20">
                  <div>
                    <span className="text-[10px] font-bold text-foreground/50 uppercase tracking-wider block">Price</span>
                  ...
                  <button className="bg-primary hover:bg-primary-dark text-white font-sans text-xs font-bold px-4 py-2 rounded-full transition-colors flex items-center gap-1.5 shadow-md shadow-primary/10">
                    Buy Direct
                  </button>
                </div>
              </div>
